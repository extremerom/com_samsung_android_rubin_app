.class public Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/PreferredDomainsAnalyzer;
...
.method public createPreferredContents(LZ5/p;J)Ljava/util/List;
    ...
    iget-object v6, v4, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/G;->d:Ljava/lang/String;
    ...
    iput-wide v7, v6, LZ5/T;->n:J

    iput-object v5, v6, LZ5/T;->o:Ljava/lang/String;
    ...
    :goto_3
    iget-wide v4, v6, LZ5/T;->p:J

    add-long/2addr v4, v11

    iput-wide v4, v6, LZ5/T;->p:J
...
.method public updatePreferredContentList(Ljava/util/List;)V
    ...
    iget-object v0, v0, Ll5/c;->u:Ll5/f0;

    monitor-enter v0

    :try_start_0
    iget-object v1, v0, Ll5/f0;->a:Ll5/b;
    ...
    :cond_0
    :try_start_1
    const-string v4, "preferred_domains"
    ...
    const-string v1, "successfully deleted the preferred Domains list"
    ...
    iget-object v7, v5, LZ5/T;->o:Ljava/lang/String;
    ...
    :cond_7
    iget-object v4, v0, Ll5/f0;->a:Ll5/b;
    ...
    const-string v8, "preferred_domains"
    ...
    const-string v2, "successfully inserted the preferred Domains list, size="
    ...
    const-class p1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/PreferredDomainsAnalyzer;
