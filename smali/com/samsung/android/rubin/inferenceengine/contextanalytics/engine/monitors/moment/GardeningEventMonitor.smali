.class public Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    sget-object v3, LN5/d;->h:LN5/d;

    const-class v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;

    invoke-virtual {v0}, Ljava/lang/Class;->getCanonicalName()Ljava/lang/String;

    move-result-object v4

    sget-object v6, La6/d;->h:La6/d;

    sget-object v7, La6/d;->i:La6/d;

    const-string v5, "gardening_event_monitor"
    ...
    iput-boolean p1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;->mIsHome:Z
    ...
    iput-object p1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;->mCurrentPlaceMonitorChangedReceiver:Landroid/content/BroadcastReceiver;

    return-void
.end method

.method public static bridge synthetic b(Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;)V
    .locals 0

    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;->updateIsHome()V
...
.method private registerProviderChangedReceiver()V
    ...
    :cond_0
    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;->mCurrentPlaceMonitorChangedReceiver:Landroid/content/BroadcastReceiver;
...
.method private updateIsHome()V
    ...
    iput-boolean v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;->mIsHome:Z

    goto :goto_1

    :cond_1
    iput-boolean v1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;->mIsHome:Z
...
.method public isSatisfiedAllPreConditions()Z
    ...
    iget-boolean p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;->mIsHome:Z
...
.method public notifyChanged()V
    ...
    sget-object v1, Lz4/s;->a:Landroid/net/Uri;
    ...
    const-class v1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;
...
.method public registerReceivers()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;->registerProviderChangedReceiver()V
...
.method public unregisterReceivers()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/GardeningEventMonitor;->unregisterProviderChangedReceiver()V
