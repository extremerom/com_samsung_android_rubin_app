.class public Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/PreferredMusicArtistAnalyzer;
...
.method public createPreferredContents(LZ5/p;J)Ljava/util/List;
    ...
    iget-object v5, v4, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/MusicPlaybackLog;->e:Ljava/lang/String;
    ...
    iput-wide v7, v6, LZ5/W;->n:J

    iget-object v7, v4, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/MusicPlaybackLog;->e:Ljava/lang/String;

    iput-object v7, v6, LZ5/W;->o:Ljava/lang/String;
    ...
    :goto_2
    iget-wide v4, v6, LZ5/W;->p:J

    add-long/2addr v4, v11

    iput-wide v4, v6, LZ5/W;->p:J
...
.method public updatePreferredContentList(Ljava/util/List;)V
    ...
    iget-object v0, v0, Ll5/c;->x:Ll5/g0;

    monitor-enter v0

    :try_start_0
    iget-object v1, v0, Ll5/g0;->a:Ll5/b;
    ...
    :cond_0
    :try_start_1
    const-string v4, "preferred_musicartists"
    ...
    const-string v1, "successfully deleted the preferred MusicArtists list"
    ...
    iget-object v7, v5, LZ5/W;->o:Ljava/lang/String;
    ...
    :cond_7
    iget-object v4, v0, Ll5/g0;->a:Ll5/b;
    ...
    const-string v8, "preferred_musicartists"
    ...
    const-string v2, "successfully inserted the preferred MusicArtists list, size="
    ...
    sget-object v0, LA4/y;->a:Landroid/net/Uri;
    ...
    const-class p1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/PreferredMusicArtistAnalyzer;
