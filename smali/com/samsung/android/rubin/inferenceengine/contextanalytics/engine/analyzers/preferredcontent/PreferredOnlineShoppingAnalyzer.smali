.class public Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/PreferredOnlineShoppingAnalyzer;
...
.method private onlineShoppingAppAndUrlFilter(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    .locals 5
    ...
    check-cast v1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/G;
    ...
    invoke-static {v2}, LJ6/k;->a(Landroid/content/Context;)LJ6/k;

    move-result-object v2

    iget-object v3, v1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/G;->d:Ljava/lang/String;

    invoke-static {v3}, Ljava/lang/String;->valueOf(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, LJ6/k;->c(Ljava/lang/String;)Z
    ...
    invoke-direct {v2, v3, v4}, La6/F;-><init>(J)V
    ...
    invoke-static {v1}, LJ6/k;->a(Landroid/content/Context;)LJ6/k;

    move-result-object v1

    iget-object v2, p2, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/AppUsage;->c:Ljava/lang/String;

    invoke-virtual {v1, v2}, LJ6/k;->b(Ljava/lang/String;)Z
    ...
    invoke-direct {v1, v2, v3}, La6/F;-><init>(J)V
...
.method public createPreferredContents(LZ5/p;J)Ljava/util/List;
    ...
    iget v3, v2, La6/F;->c:I

    invoke-static {v3}, LTa/b;->C(I)Ljava/lang/String;
    ...
    iput-wide v4, v3, LZ5/Y;->n:J

    iput-wide p2, v3, LZ5/Q;->m:J

    iget v4, v2, La6/F;->c:I

    invoke-static {v4}, LTa/b;->C(I)Ljava/lang/String;
    ...
    :goto_1
    iget-wide v4, v3, LZ5/Y;->o:J

    add-long/2addr v4, v7

    iput-wide v4, v3, LZ5/Y;->o:J
...
.method public readLogList(J)Ljava/util/List;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/UrlKeywordDatabase;->readWebLogList(J)Ljava/util/List;

    move-result-object v0

    iget-object v1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/AbstractPreferredContentAnalyzer;->mLoggingDatabase:Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;
    ...
    invoke-virtual {v1, p1, p2}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/AppUsageDatabase;->readMergedAppUsageList(J)Ljava/util/List;

    move-result-object p1

    invoke-direct {p0, p1, v0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/PreferredOnlineShoppingAnalyzer;->onlineShoppingAppAndUrlFilter(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
...
.method public updatePreferredContentList(Ljava/util/List;)V
    ...
    iget-object v0, v0, Ll5/c;->y:Ll5/j0;

    monitor-enter v0

    :try_start_0
    iget-object v1, v0, Ll5/j0;->a:Ll5/b;
    ...
    :cond_0
    :try_start_1
    const-string v4, "preferred_online_shopping"
    ...
    const-string v1, "successfully deleted the preferred Shopping list"
    ...
    :cond_7
    iget-object v4, v0, Ll5/j0;->a:Ll5/b;
    ...
    const-string v8, "preferred_online_shopping"
    ...
    const-string v2, "successfully inserted the preferred Shopping list, size="
    ...
    sget-object v0, LA4/B;->a:Landroid/net/Uri;
    ...
    const-class p1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/PreferredOnlineShoppingAnalyzer;
