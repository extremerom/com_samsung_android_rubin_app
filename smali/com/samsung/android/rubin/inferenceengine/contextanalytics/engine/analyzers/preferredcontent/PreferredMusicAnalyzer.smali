.class public Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/PreferredMusicAnalyzer;
...
.method private getKey(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p0, p2}, Ll6/k;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public createPreferredContents(LZ5/p;J)Ljava/util/List;
    ...
    check-cast v5, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/MusicPlaybackLog;

    iget-object v6, v5, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/MusicPlaybackLog;->c:Ljava/lang/String;

    iget-object v7, v5, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/MusicPlaybackLog;->d:Ljava/lang/String;

    invoke-direct {v0, v6, v7}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/PreferredMusicAnalyzer;->getKey(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-wide v9, v8, LZ5/V;->n:J

    iget-object v9, v5, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/MusicPlaybackLog;->c:Ljava/lang/String;

    iput-object v9, v8, LZ5/V;->o:Ljava/lang/String;

    iput-object v7, v8, LZ5/V;->p:Ljava/lang/String;
    ...
    iget-object v7, v8, LZ5/Q;->l:Ljava/util/LinkedHashMap;
    ...
    iget-wide v5, v8, LZ5/Q;->j:J

    add-long/2addr v5, v12

    iput-wide v5, v8, LZ5/Q;->j:J
...
.method public readLogList(J)Ljava/util/List;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/MusicPlaybackDatabase;->readMusicPlaybackListWithoutMeaninglessTrack(J)Ljava/util/List;
...
.method public updatePreferredContentList(Ljava/util/List;)V
    ...
    iget-object v0, v0, Ll5/c;->v:Ll5/i0;

    monitor-enter v0

    :try_start_0
    iget-object v1, v0, Ll5/i0;->a:Ll5/b;
    ...
    :cond_0
    :try_start_1
    const-string v4, "preferred_musics"
    ...
    const-string v1, "successfully deleted the preferred Musics list"
    ...
    iget-object v7, v5, LZ5/V;->o:Ljava/lang/String;

    invoke-virtual {v8, v6, v7}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const-string v6, "album"

    iget-object v7, v5, LZ5/V;->p:Ljava/lang/String;
    ...
    :cond_7
    iget-object v4, v0, Ll5/i0;->a:Ll5/b;
    ...
    const-string v2, "successfully inserted the preferred Musics list, size="
    ...
    sget-object v0, LA4/x;->a:Landroid/net/Uri;
    ...
    const-class p1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/PreferredMusicAnalyzer;
