.class public Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    sget-object v3, LN5/d;->f:LN5/d;

    const-class v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;

    invoke-virtual {v0}, Ljava/lang/Class;->getCanonicalName()Ljava/lang/String;

    move-result-object v4

    sget-object v6, La6/d;->d:La6/d;

    sget-object v7, La6/d;->e:La6/d;

    const-string v5, "cooking_event_monitor"
    ...
    iput-boolean p1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;->mIsHome:Z
    ...
    iput-object p1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;->mCurrentPlaceMonitorChangedReceiver:Landroid/content/BroadcastReceiver;

    return-void
.end method

.method public static bridge synthetic b(Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;)V
    .locals 0

    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;->updateIsHome()V
...
.method private registerProviderChangedReceiver()V
    ...
    :cond_0
    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;->mCurrentPlaceMonitorChangedReceiver:Landroid/content/BroadcastReceiver;
...
.method private updateIsHome()V
    ...
    iput-boolean v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;->mIsHome:Z

    goto :goto_1

    :cond_1
    iput-boolean v1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;->mIsHome:Z
...
.method public isSatisfiedAllPreConditions()Z
    ...
    iget-boolean p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;->mIsHome:Z
...
.method public notifyChanged()V
    ...
    sget-object v1, Lz4/h;->a:Landroid/net/Uri;
    ...
    const-class v1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;
...
.method public registerReceivers()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;->registerProviderChangedReceiver()V
...
.method public unregisterReceivers()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/CookingEventMonitor;->unregisterProviderChangedReceiver()V
