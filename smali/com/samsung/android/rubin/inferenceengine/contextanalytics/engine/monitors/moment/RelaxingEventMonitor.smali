.class public Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    sget-object v3, LN5/d;->l:LN5/d;

    const-class v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;

    invoke-virtual {v0}, Ljava/lang/Class;->getCanonicalName()Ljava/lang/String;

    move-result-object v4

    sget-object v6, La6/d;->V:La6/d;

    sget-object v7, La6/d;->W:La6/d;

    const-string v5, "relaxing_event_monitor"
    ...
    iput-boolean p1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;->mIsHome:Z
    ...
    iput-object p1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;->mCurrentPlaceMonitorChangedReceiver:Landroid/content/BroadcastReceiver;

    return-void
.end method

.method public static bridge synthetic b(Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;)V
    .locals 0

    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;->updateIsHome()V
...
.method private registerProviderChangedReceiver()V
    ...
    :cond_0
    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;->mCurrentPlaceMonitorChangedReceiver:Landroid/content/BroadcastReceiver;
...
.method private updateIsHome()V
    ...
    iput-boolean v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;->mIsHome:Z

    goto :goto_1

    :cond_1
    iput-boolean v1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;->mIsHome:Z
...
.method public isSatisfiedAllPreConditions()Z
    ...
    iget-boolean p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;->mIsHome:Z
...
.method public notifyChanged()V
    ...
    const-class v1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;
...
.method public registerReceivers()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;->registerProviderChangedReceiver()V
...
.method public unregisterReceivers()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/monitors/moment/RelaxingEventMonitor;->unregisterProviderChangedReceiver()V
