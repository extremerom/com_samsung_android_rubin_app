.class public Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;
...
# instance fields
.field private final mAnalysisBroadcastReceiver:Lw5/k;
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->ANALYSIS_DELAY_TIME:J
    ...
    sput-wide v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->MIN_ANALYSIS_PERIOD:J
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mContext:Landroid/content/Context;

    iput-object p2, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mMainHandler:Landroid/os/Handler;

    new-instance p2, Lw5/k;

    invoke-direct {p2, p0}, Lw5/k;-><init>(Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;)V

    iput-object p2, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mAnalysisBroadcastReceiver:Lw5/k;
    ...
    iput-object p2, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mLoggingDatabase:Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;

    invoke-static {p1}, Ll5/c;->d(Landroid/content/Context;)Ll5/c;

    move-result-object p1

    iput-object p1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mAnalyticsDatabase:Ll5/c;

    return-void
.end method

.method public static bridge synthetic a(Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;)J
    .locals 2

    iget-wide v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mLastAnalysisTime:J

    return-wide v0
.end method

.method public static bridge synthetic b(Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;)Landroid/os/Handler;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mMainHandler:Landroid/os/Handler;
...
.method public static bridge synthetic c()J
    ...
    sget-wide v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->ANALYSIS_DELAY_TIME:J
...
.method public static bridge synthetic d()J
    ...
    sget-wide v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->MIN_ANALYSIS_PERIOD:J

    return-wide v0
.end method

.method private getAttachedAppTpoContextFeatureList(Ljava/util/List;Ljava/util/Map;Lw5/l;)Ljava/util/List;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v3, v4, p2}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->getTimestampToAttach(JLjava/util/Map;)J
...
.method private getBaseMultiWindowTpoContextFeatureList(Ljava/util/List;)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v3, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/D;

    invoke-virtual {v3}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/D;->toString()Ljava/lang/String;
    ...
    iget v4, v3, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/D;->d:I

    const/4 v5, 0x2

    if-ne v4, v5, :cond_3

    iget v4, v3, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/D;->e:I
    ...
    :cond_0
    iget-object v4, v3, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/D;->f:Ljava/util/ArrayList;

    iget-object v5, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mContext:Landroid/content/Context;
    ...
    const-string v3, " is launcher app."

    invoke-static {v7, v3}, Lai/onnxruntime/a;->x(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v4, v3, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/D;->f:Ljava/util/ArrayList;

    invoke-virtual {v3}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/D;->d()Ljava/lang/String;

    move-result-object v4

    iget-wide v5, v3, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/D;->c:J

    new-instance v7, LZ5/B;

    invoke-direct {v7, v4, v5, v6}, LZ5/B;-><init>(Ljava/lang/String;J)V
    ...
    iget-object v3, v3, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/c;->b:Ljava/lang/String;
    ...
    iput-wide v4, v7, LZ5/B;->a:D

    iput v3, v7, LZ5/B;->b:I
...
.method private getFeatureList(Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/D;

    iget-wide v6, v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/D;->c:J

    iget-object v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mContext:Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mLoggingDatabase:Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->getMultiWindowTpoContextFeatureList(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;J)Ljava/util/List;
...
.method private getMultiWindowTpoContextFeatureList(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;J)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->getBaseMultiWindowTpoContextFeatureList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    invoke-direct {p0, p5, p6, p2}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->getTimedTpoContextEventListMap(JLjava/util/List;)Ljava/util/Map;

    move-result-object p2

    sget-object v0, Lw5/l;->a:Lw5/l;

    invoke-direct {p0, p1, p2, v0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->getAttachedAppTpoContextFeatureList(Ljava/util/List;Ljava/util/Map;Lw5/l;)Ljava/util/List;

    move-result-object p1

    invoke-direct {p0, p5, p6, p3}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->getTimedBluetoothCODListMap(JLjava/util/List;)Ljava/util/Map;

    move-result-object p2

    sget-object p3, Lw5/l;->b:Lw5/l;

    invoke-direct {p0, p1, p2, p3}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->getAttachedAppTpoContextFeatureList(Ljava/util/List;Ljava/util/Map;Lw5/l;)Ljava/util/List;

    move-result-object p1

    invoke-direct {p0, p5, p6, p4}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->getTimedHeadSetConnectionTypeMap(JLjava/util/List;)Ljava/util/Map;

    move-result-object p2

    sget-object p3, Lw5/l;->c:Lw5/l;
...
.method private getTimedBluetoothCODListMap(JLjava/util/List;)Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mLoggingDatabase:Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;
    ...
    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mLoggingDatabase:Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;
...
.method private getTimedTpoContextEventListMap(JLjava/util/List;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mContext:Landroid/content/Context;
...
.method private registerBroadcastReceiver()V
    ...
    :cond_0
    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mAnalysisBroadcastReceiver:Lw5/k;
...
.method private saveLRPredictor(Lq5/a;)V
    ...
    const-string v1, "preferred_multi_window"
    ...
    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mAnalyticsDatabase:Ll5/c;
    ...
    const-string v0, "preferred_multi_window"
...
.method public analyze()V
    ...
    invoke-virtual {v1}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;->getScreenDatabase()Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/ScreenDatabase;

    move-result-object v1

    iget-wide v4, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mLastAnalysisTime:J

    invoke-virtual {v1, v4, v5}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/ScreenDatabase;->readMultiWindowList(J)Ljava/util/List;

    move-result-object v1

    invoke-direct {p0, v1}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->getFeatureList(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    iget-object v2, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mContext:Landroid/content/Context;
    ...
    const-string v5, "preferred_multi_window"

    const/4 v6, 0x0

    invoke-virtual {v2, v5, v6, v1, v4}, Lcom/google/android/gms/internal/ads/jg;->i(Ljava/lang/String;Lw5/n;Ljava/util/List;I)F
    ...
    invoke-virtual {v2, v5, v6, v1, v3}, Lcom/google/android/gms/internal/ads/jg;->i(Ljava/lang/String;Lw5/n;Ljava/util/List;I)F
    ...
    iget-object v6, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mContext:Landroid/content/Context;
    ...
    iget-object v6, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mLoggingDatabase:Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;

    invoke-virtual {v6}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;->getScreenDatabase()Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/ScreenDatabase;

    move-result-object v6

    invoke-virtual {v6, v4, v5}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/ScreenDatabase;->readMultiWindowList(J)Ljava/util/List;

    move-result-object v4

    invoke-direct {p0, v4}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->getFeatureList(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, v5, v6}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->getTimeDecayList(Ljava/util/List;I)Ljava/util/List;

    move-result-object v5

    invoke-direct {p0, v5}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->buildLRPredictor(Ljava/util/List;)Lq5/a;

    move-result-object v6

    invoke-direct {p0, v6}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->saveLRPredictor(Lq5/a;)V
    ...
    const-class v8, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;
    ...
    iput-wide v6, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mLastAnalysisTime:J
    ...
    iget-object v8, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mContext:Landroid/content/Context;
    ...
    iget-wide v13, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mLastAnalysisTime:J
...
.method public init()V
    ...
    iput-wide v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->mLastAnalysisTime:J
...
.method public start()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->registerBroadcastReceiver()V
...
.method public stop()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/preferredcontent/GenericPreferredMultiWindowAnalyzer;->unregisterBroadcastReceiver()V
