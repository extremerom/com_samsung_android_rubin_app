.class public Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;
...
# instance fields
.field private final generalLRLogDao:Ll5/u;

.field private final mAnalysisBroadcastReceiver:Lo5/a;
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->ANALYSIS_DELAY_TIME:J
    ...
    sput-wide v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->MIN_ANALYSIS_PERIOD:J
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mContext:Landroid/content/Context;

    iput-object p2, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mMainHandler:Landroid/os/Handler;

    new-instance p2, Lo5/a;

    invoke-direct {p2, p0}, Lo5/a;-><init>(Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;)V

    iput-object p2, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mAnalysisBroadcastReceiver:Lo5/a;
    ...
    iput-object p2, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mLoggingDatabase:Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;

    invoke-static {p1}, Ll5/c;->d(Landroid/content/Context;)Ll5/c;

    move-result-object p2

    iput-object p2, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mAnalyticsDatabase:Ll5/c;
    ...
    invoke-virtual {p1}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/analytics/GeneralPreferenceDatabase;->b()Ll5/u;

    move-result-object p1

    iput-object p1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->generalLRLogDao:Ll5/u;

    return-void
.end method

.method public static bridge synthetic a(Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;)J
    .locals 2

    iget-wide v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mLastAnalysisTime:J

    return-wide v0
.end method

.method public static bridge synthetic b(Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;)Landroid/os/Handler;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mMainHandler:Landroid/os/Handler;
...
.method public static bridge synthetic c()J
    ...
    sget-wide v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->ANALYSIS_DELAY_TIME:J
...
.method public static bridge synthetic d()J
    ...
    sget-wide v0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->MIN_ANALYSIS_PERIOD:J

    return-wide v0
.end method

.method private getAttachedTpoContextFeatureList(Ljava/util/List;Ljava/util/Map;Lo5/b;)Ljava/util/List;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v3, v4, p2}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->getTimestampToAttach(JLjava/util/Map;)J
...
.method private getBaseTpoContextFeatureList(Ljava/util/List;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v2, v1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/model/GeneralLRLog;->c:Ljava/lang/String;

    iget-wide v3, v1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/models/logger/c;->a:J

    new-instance v5, LZ5/B;

    iget-object v6, v1, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/model/GeneralLRLog;->d:Ljava/util/List;

    invoke-direct {v5, v2, v6, v3, v4}, LZ5/B;-><init>(Ljava/lang/String;Ljava/util/List;J)V
...
.method private getFeatureList(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mContext:Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mLoggingDatabase:Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->getTpoContextFeatureList(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;J)Ljava/util/List;
...
.method private getTimedBluetoothCODListMap(JLjava/util/List;)Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mLoggingDatabase:Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;
    ...
    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mLoggingDatabase:Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/loggers/LoggingDatabaseManager;
...
.method private getTimedTpoContextEventListMap(JLjava/util/List;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mContext:Landroid/content/Context;
...
.method private getTpoContextFeatureList(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;J)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->getBaseTpoContextFeatureList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    invoke-direct {p0, p5, p6, p2}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->getTimedTpoContextEventListMap(JLjava/util/List;)Ljava/util/Map;

    move-result-object p2

    sget-object v0, Lo5/b;->a:Lo5/b;

    invoke-direct {p0, p1, p2, v0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->getAttachedTpoContextFeatureList(Ljava/util/List;Ljava/util/Map;Lo5/b;)Ljava/util/List;

    move-result-object p1

    invoke-direct {p0, p5, p6, p3}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->getTimedBluetoothCODListMap(JLjava/util/List;)Ljava/util/Map;

    move-result-object p2

    sget-object p3, Lo5/b;->b:Lo5/b;

    invoke-direct {p0, p1, p2, p3}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->getAttachedTpoContextFeatureList(Ljava/util/List;Ljava/util/Map;Lo5/b;)Ljava/util/List;

    move-result-object p1

    invoke-direct {p0, p5, p6, p4}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->getTimedHeadSetConnectionTypeMap(JLjava/util/List;)Ljava/util/Map;

    move-result-object p2

    sget-object p3, Lo5/b;->c:Lo5/b;
...
.method private saveLRPredictor(Ljava/lang/String;Lq5/a;)V
    .locals 8
    ...
    iget-object v0, p2, Lq5/a;->a:LVa/b;
    ...
    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mAnalyticsDatabase:Ll5/c;

    iget-object p0, p0, Ll5/c;->n:Ll5/X;

    iget-object p2, p2, Lq5/a;->b:[[D
    ...
    invoke-virtual {p0, v7, p1, p2}, Ll5/X;->f(LD7/b;Ljava/lang/String;[[D)V
...
.method private unregisterBroadcastReceiver()V
    ...
    :cond_0
    iget-object p0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mAnalysisBroadcastReceiver:Lo5/a;
...
# virtual methods
.method public analyze(Ljava/lang/String;)I
    .locals 3

    iget-object v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->generalLRLogDao:Ll5/u;
    ...
    invoke-direct {v1, v0, p1, v2}, Ll5/s;-><init>(Ll5/u;Ljava/lang/String;Lfa/d;)V

    sget-object v0, Lfa/j;->a:Lfa/j;

    invoke-static {v0, v1}, LGb/y;->o(Lfa/i;Lpa/c;)Ljava/lang/Object;
    ...
    const-string v2, "Analyze starts, log size: "

    invoke-direct {v1, v2}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v1, v0}, LA1/G;->o(Ljava/lang/StringBuilder;Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->analyze(Ljava/lang/String;Ljava/util/List;)I
...
.method public analyze(Ljava/lang/String;Ljava/util/List;)I
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->getFeatureList(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, p2, v4}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->getTimeDecayList(Ljava/util/List;I)Ljava/util/List;

    move-result-object p2

    invoke-direct {p0, p2}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->buildLRPredictor(Ljava/util/List;)Lq5/a;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->saveLRPredictor(Ljava/lang/String;Lq5/a;)V
    ...
    const-class p2, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;
    ...
    invoke-static {p0, p1, p2, v1}, Ll6/k;->d(FFLjava/lang/StringBuilder;Ljava/lang/String;)Ljava/lang/String;
...
.method public analyze()V
    ...
    iget-object v3, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mContext:Landroid/content/Context;
    ...
    :try_start_0
    iget-object v4, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->generalLRLogDao:Ll5/u;
    ...
    invoke-direct {v5, v4, v6}, Ll5/q;-><init>(Ll5/u;Lfa/d;)V
    ...
    iget-object v5, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mContext:Landroid/content/Context;
    ...
    const-string v7, "GeneralPreference Database broken!! do recreate!! success? "

    invoke-static {v7, v6}, LA1/G;->k(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-virtual {v4, v5}, Ll5/F;->a(Landroid/content/Context;)Lcom/samsung/android/rubin/inferenceengine/contextanalytics/database/analytics/GeneralPreferenceDatabase;
    ...
    iget-object v6, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mMainHandler:Landroid/os/Handler;
    ...
    invoke-direct {v7, v8, p0, v5, v9}, Lcom/google/android/gms/internal/ads/xl;-><init>(ILjava/lang/Object;Ljava/lang/Object;Z)V

    sget-wide v8, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->ANALYSIS_DELAY_TIME:J
    ...
    iput-wide v4, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mLastAnalysisTime:J
    ...
    iget-object v6, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mContext:Landroid/content/Context;
    ...
    iget-wide v11, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mLastAnalysisTime:J
...
.method public init()V
    ...
    iput-wide v0, p0, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->mLastAnalysisTime:J
...
.method public start()V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->registerBroadcastReceiver()V
...
.method public stop()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/rubin/inferenceengine/contextanalytics/engine/analyzers/general/GeneralLRAnalyzer;->unregisterBroadcastReceiver()V
