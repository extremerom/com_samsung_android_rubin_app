.class public final Lcom/samsung/android/sdk/healthdata/j;
...
.field public final b:Lcom/samsung/android/sdk/healthdata/i;

.field public c:Lcom/samsung/android/sdk/healthdata/x;

.field public final d:Landroidx/appcompat/app/f;

.field public e:Lcom/samsung/android/sdk/internal/healthdata/i;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/samsung/android/sdk/healthdata/i;)V
    .locals 2
    ...
    invoke-direct {v0, p0}, Landroidx/appcompat/app/f;-><init>(Lcom/samsung/android/sdk/healthdata/j;)V

    iput-object v0, p0, Lcom/samsung/android/sdk/healthdata/j;->d:Landroidx/appcompat/app/f;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/samsung/android/sdk/healthdata/j;->f:Ljava/lang/Boolean;

    const-wide/32 v0, 0xea60

    iput-wide v0, p0, Lcom/samsung/android/sdk/healthdata/j;->g:J

    new-instance v0, LC8/a;

    const/4 v1, 0x3

    invoke-direct {v0, v1, p0}, LC8/a;-><init>(ILjava/lang/Object;)V

    iput-object v0, p0, Lcom/samsung/android/sdk/healthdata/j;->h:LC8/a;

    const-string v0, " is null"

    if-eqz p1, :cond_2

    iput-object p1, p0, Lcom/samsung/android/sdk/healthdata/j;->a:Landroid/content/Context;

    if-eqz p2, :cond_1

    iput-object p2, p0, Lcom/samsung/android/sdk/healthdata/j;->b:Lcom/samsung/android/sdk/healthdata/i;

    sget-object p0, Lcom/samsung/android/sdk/healthdata/j;->i:Ljava/lang/String;
    ...
    sput-object p0, Lcom/samsung/android/sdk/healthdata/j;->i:Ljava/lang/String;
...
.method public static a(Lcom/samsung/android/sdk/healthdata/j;Lcom/samsung/android/sdk/healthdata/x;)V
    .locals 13

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v0, "Service for HealthDataStore is connected"
    ...
    iget-object v2, p0, Lcom/samsung/android/sdk/healthdata/j;->a:Landroid/content/Context;
    ...
    const-string v7, "userPasswordInputMode"
    ...
    :goto_1
    const-string v9, "com.samsung.android.sdk.healthdata.IHealth"
    ...
    check-cast v4, Lcom/samsung/android/sdk/healthdata/v;
    ...
    invoke-virtual {v0, v7, v6}, Landroid/os/Bundle;->writeToParcel(Landroid/os/Parcel;I)V

    iget-object v0, v4, Lcom/samsung/android/sdk/healthdata/v;->a:Landroid/os/IBinder;

    const/16 v4, 0xa

    invoke-interface {v0, v4, v7, v10, v6}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    check-cast v7, Lcom/samsung/android/sdk/healthdata/v;
    ...
    iget-object v0, v7, Lcom/samsung/android/sdk/healthdata/v;->a:Landroid/os/IBinder;

    const/4 v4, 0x2

    invoke-interface {v0, v4, v10, v12, v6}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {v11, v0, v6}, Landroid/os/BaseBundle;->getInt(Ljava/lang/String;I)I
    ...
    iget-object v7, p0, Lcom/samsung/android/sdk/healthdata/j;->d:Landroidx/appcompat/app/f;
    ...
    invoke-virtual {v7, v0, v2, v3}, Landroid/os/Handler;->sendEmptyMessageDelayed(IJ)Z
    ...
    const-string v0, "User password popup is required"
    ...
    const-string v10, "Pop up PinCode activity pkg = "
    ...
    const-string v4, "Only this app cannot access with this "
    ...
    :cond_8
    :goto_7
    iget-wide v3, p0, Lcom/samsung/android/sdk/healthdata/j;->g:J

    const-string v0, "Waiting for initialization of Health framework ..."

    invoke-static {v1, v0}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {p0}, Lcom/samsung/android/sdk/healthdata/j;->f()V
    ...
    new-instance v8, Lcom/samsung/android/sdk/internal/healthdata/i;

    invoke-direct {v8, v1, v0}, Lcom/samsung/android/sdk/internal/healthdata/i;-><init>(Landroid/os/Looper;Lcom/samsung/android/sdk/internal/healthdata/HealthResultReceiver$ForwardAsync;)V

    iput-object v8, v0, Lcom/samsung/android/sdk/internal/healthdata/HealthResultReceiver$ForwardAsync;->c:LJ8/b;
    ...
    invoke-virtual {v0, v10, v6}, Lcom/samsung/android/sdk/internal/healthdata/HealthResultReceiver$ForwardAsync;->writeToParcel(Landroid/os/Parcel;I)V

    invoke-virtual {v10, v3, v4}, Landroid/os/Parcel;->writeLong(J)V

    iget-object v0, v2, Lcom/samsung/android/sdk/healthdata/v;->a:Landroid/os/IBinder;

    const/16 v1, 0xc

    invoke-interface {v0, v1, v10, v11, v6}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    iput-object v8, p0, Lcom/samsung/android/sdk/healthdata/j;->e:Lcom/samsung/android/sdk/internal/healthdata/i;

    new-instance v0, Lcom/samsung/android/sdk/healthdata/g;

    invoke-direct {v0, p0, p1}, Lcom/samsung/android/sdk/healthdata/g;-><init>(Lcom/samsung/android/sdk/healthdata/j;Lcom/samsung/android/sdk/healthdata/x;)V

    invoke-virtual {v8, v0}, LJ8/b;->c(Lcom/samsung/android/sdk/healthdata/l;)V

    const/4 p0, 0x5

    invoke-virtual {v7, p0, v3, v4}, Landroid/os/Handler;->sendEmptyMessageDelayed(IJ)Z
...
.method public static e(Lcom/samsung/android/sdk/healthdata/j;)Lcom/samsung/android/sdk/healthdata/x;
    .locals 1

    if-eqz p0, :cond_1

    iget-object p0, p0, Lcom/samsung/android/sdk/healthdata/j;->c:Lcom/samsung/android/sdk/healthdata/x;
...
.method public final c()V
    ...
    iget-object v0, p0, Lcom/samsung/android/sdk/healthdata/j;->d:Landroidx/appcompat/app/f;
    ...
    invoke-static {v7}, Lcom/samsung/android/sdk/healthdata/j;->b([Landroid/content/pm/Signature;)Z
    ...
    const-string v3, "Failed to check signature"
    ...
    const-string v8, "com.samsung.android.sdk.healthdata.IHealthDataStore"
    ...
    :try_start_3
    iget-object v8, p0, Lcom/samsung/android/sdk/healthdata/j;->h:LC8/a;

    const/16 v9, 0x41

    invoke-virtual {v2, v7, v8, v9}, Landroid/content/Context;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    iput-wide v2, p0, Lcom/samsung/android/sdk/healthdata/j;->g:J
    :try_end_3
    ...
    invoke-virtual {p0, v7, v2}, Landroid/content/pm/PackageManager;->resolveService(Landroid/content/Intent;I)Landroid/content/pm/ResolveInfo;
...
.method public final d()V
    ...
    iget-object v0, p0, Lcom/samsung/android/sdk/healthdata/j;->a:Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/samsung/android/sdk/healthdata/j;->h:LC8/a;
...
.method public final declared-synchronized f()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/samsung/android/sdk/healthdata/j;->e:Lcom/samsung/android/sdk/internal/healthdata/i;

    if-eqz v0, :cond_2

    iget-object v1, v0, LJ8/b;->a:Ljava/lang/Object;
    ...
    :try_start_1
    iget-boolean v2, v0, LJ8/b;->g:Z

    const/4 v3, 0x0

    if-nez v2, :cond_1

    iget-boolean v2, v0, LJ8/b;->f:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :try_start_2
    iget-object v4, v0, Lcom/samsung/android/sdk/internal/healthdata/i;->h:Lcom/samsung/android/sdk/internal/healthdata/HealthResultReceiver$ForwardAsync;

    iget-object v4, v4, Lcom/samsung/android/sdk/internal/healthdata/HealthResultReceiver$ForwardAsync;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :try_start_3
    const-string v5, "Health.ResultHolder"
    ...
    :goto_0
    iput-object v3, v0, LJ8/b;->d:Lcom/samsung/android/sdk/healthdata/l;

    iput-boolean v2, v0, LJ8/b;->g:Z
    ...
    :goto_2
    :try_start_4
    iput-object v3, p0, Lcom/samsung/android/sdk/healthdata/j;->e:Lcom/samsung/android/sdk/internal/healthdata/i;
    :try_end_4
