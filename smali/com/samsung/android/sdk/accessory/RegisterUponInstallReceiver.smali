...
.method public final onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    new-instance p2, Lcom/samsung/android/sdk/accessory/j;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    invoke-direct {p2, p1}, Lcom/samsung/android/sdk/accessory/j;-><init>(Landroid/content/Context;)V

    invoke-virtual {p2}, Lcom/samsung/android/sdk/accessory/j;->a()Ljava/util/concurrent/Future;

    move-result-object p1

    new-instance v0, Lcom/samsung/android/sdk/accessory/RegisterUponInstallReceiver$1;

    const-string v1, "RegistrationThread"

    invoke-direct {v0, v1, p1, p0}, Lcom/samsung/android/sdk/accessory/RegisterUponInstallReceiver$1;-><init>(Ljava/lang/String;Ljava/util/concurrent/Future;Landroid/content/BroadcastReceiver$PendingResult;)V

    invoke-virtual {v0}, Ljava/lang/Thread;->start()V

    invoke-virtual {p2}, Lcom/samsung/android/sdk/accessory/j;->b()V
