...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "()Landroidx/appcompat/widget/P0;",
        "setIndicator",
        "(Landroidx/appcompat/widget/P0;)V",
        "material_release"
    }
    k = 0x1
    mv = {
...
.field private indicator:Landroidx/appcompat/widget/P0;
...
.method private final getViewPagerBackgroundColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1}, LA8/c;->y(Landroid/content/Context;)Z
...
.method public final getIndicator()Landroidx/appcompat/widget/P0;
    .locals 0

    iget-object p0, p0, Lcom/google/android/material/appbar/model/view/ViewPagerAppBarView;->indicator:Landroidx/appcompat/widget/P0;
...
.method public inflate()V
    ...
    iput-object v8, v3, Landroidx/appcompat/widget/P0;->a:Ljava/util/ArrayList;
    ...
    invoke-static {v6}, LA8/c;->y(Landroid/content/Context;)Z

    move-result v10

    if-eqz v10, :cond_3

    invoke-static {v6}, LA8/c;->B(Landroid/content/Context;)Z
    ...
    :goto_2
    iput-object v9, v3, Landroidx/appcompat/widget/P0;->c:Landroid/graphics/drawable/Drawable;
    ...
    :goto_4
    iput-object v8, v3, Landroidx/appcompat/widget/P0;->d:Landroid/graphics/drawable/Drawable;

    const/4 v6, -0x1

    iput v6, v3, Landroidx/appcompat/widget/P0;->e:I

    new-instance v6, Lr8/a;

    invoke-direct {v6, p0}, Lr8/a;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v3, v6}, Landroidx/appcompat/widget/P0;->setOnItemClickListener(Landroidx/appcompat/widget/M0;)V

    iput-object v3, p0, Lcom/google/android/material/appbar/model/view/ViewPagerAppBarView;->indicator:Landroidx/appcompat/widget/P0;
    ...
    iput-boolean v1, v3, Landroidx/viewpager2/widget/ViewPager2;->g0:Z

    iget-object v6, v3, Landroidx/viewpager2/widget/ViewPager2;->j:Landroidx/viewpager2/widget/m;
    ...
    iput-object v6, v3, Landroidx/viewpager2/widget/ViewPager2;->d0:Landroid/animation/ValueAnimator;

    sget-object v10, Landroidx/viewpager2/widget/ViewPager2;->j0:Landroid/view/animation/PathInterpolator;

    invoke-virtual {v6, v10}, Landroid/animation/ValueAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object v6, v3, Landroidx/viewpager2/widget/ViewPager2;->d0:Landroid/animation/ValueAnimator;

    new-instance v11, Landroidx/viewpager2/widget/h;

    invoke-direct {v11, v3, v4}, Landroidx/viewpager2/widget/h;-><init>(Landroidx/viewpager2/widget/ViewPager2;I)V
    ...
    iput-object v0, v3, Landroidx/viewpager2/widget/ViewPager2;->e0:Landroid/animation/ValueAnimator;

    invoke-virtual {v0, v10}, Landroid/animation/ValueAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object v0, v3, Landroidx/viewpager2/widget/ViewPager2;->e0:Landroid/animation/ValueAnimator;

    new-instance v6, Landroidx/viewpager2/widget/h;

    invoke-direct {v6, v3, v1}, Landroidx/viewpager2/widget/h;-><init>(Landroidx/viewpager2/widget/ViewPager2;I)V

    invoke-virtual {v0, v6}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object v0, v3, Landroidx/viewpager2/widget/ViewPager2;->j:Landroidx/viewpager2/widget/m;
    ...
    iget-object v3, p0, Lcom/google/android/material/appbar/model/view/ViewPagerAppBarView;->indicator:Landroidx/appcompat/widget/P0;
...
.method public final setIndicator(Landroidx/appcompat/widget/P0;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/appbar/model/view/ViewPagerAppBarView;->indicator:Landroidx/appcompat/widget/P0;
...
.method public updateResource(Landroid/content/Context;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/material/appbar/model/view/ViewPagerAppBarView;->indicator:Landroidx/appcompat/widget/P0;
    ...
    :goto_0
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/P0;->setDefaultCircle(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_2
    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/P0;->setSelectCircle(Landroid/graphics/drawable/Drawable;)V
