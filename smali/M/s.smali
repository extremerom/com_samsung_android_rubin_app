...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, LM/s;->a:Ljava/util/HashSet;

    iput-object p1, p0, LM/s;->b:Landroid/view/View;
...
# virtual methods
.method public final a(Landroid/view/View;LM/q;)V
    .locals 3

    :try_start_0
    iget-object v0, p0, LM/s;->b:Landroid/view/View;

    invoke-static {v0, p1}, LM/s;->b(Landroid/view/View;Landroid/view/View;)Landroid/graphics/Rect;
    ...
    :cond_0
    :goto_0
    new-instance p2, LM/p;

    invoke-direct {p2, v0, p1}, LM/p;-><init>(Landroid/graphics/Rect;Landroid/view/View;)V

    iget-object p0, p0, LM/s;->a:Ljava/util/HashSet;

    invoke-virtual {p0, p2}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z
    :try_end_0
    .catch LM/r; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final getTouchDelegateInfo()Landroid/view/accessibility/AccessibilityNodeInfo$TouchDelegateInfo;
    ...
    iget-object p0, p0, LM/s;->b:Landroid/view/View;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, v0, LM/p;->a:Landroid/view/View;
    ...
    iget-object v0, v0, LM/p;->a:Landroid/view/View;
