...
.method public constructor <init>(Lrb/o;)V
    ...
    invoke-direct {p0, p1}, Lsb/i;-><init>(Lrb/o;)V
...
# virtual methods
.method public bridge synthetic c()LDa/h;
    .locals 0

    invoke-virtual {p0}, Lsb/b;->m()LDa/e;
...
.method public final g()Lsb/x;
    ...
    sget-object v2, LAa/i;->e:Lbb/f;

    sget-object v2, LAa/n;->a:Lbb/e;

    invoke-static {v0, v2}, LAa/i;->b(LDa/e;Lbb/e;)Z

    move-result v2

    if-nez v2, :cond_1

    sget-object v2, LAa/n;->b:Lbb/e;
    ...
    :cond_0
    invoke-virtual {p0}, Lsb/b;->o()LAa/i;
...
.method public abstract m()LDa/e;
.end method
