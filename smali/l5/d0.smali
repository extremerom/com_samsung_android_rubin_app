...
.method public static a(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS preferred_contacts"

    invoke-virtual {p0, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v0, "CREATE TABLE IF NOT EXISTS preferred_contacts(_id INTEGER PRIMARY KEY AUTOINCREMENT,start_time INTEGER,start_time_text TEXT,end_time INTEGER,end_time_text TEXT,week_type TEXT,tpo_context TEXT,tpo_reference TEXT,tpo_reference_id INTEGER,contacts_id INTEGER,display_name TEXT,is_starred INTEGER,preferred_call_type TEXT,main_phone_number TEXT,confidence FLOAT,is_confident INTEGER,point DOUBLE,hit_count INTEGER,total_count INTEGER,updated_time INTEGER,updated_time_text TEXT,created_at INTEGER NOT NULL DEFAULT (strftime(\'%s\',\'now\')*1000));"

    invoke-virtual {p0, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v0, "preferred_contacts"
...
.method public static declared-synchronized c(Ll5/b;)Ll5/d0;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Ll5/d0;->b:Ll5/d0;
    ...
    iput-object p0, v1, Ll5/d0;->a:Ll5/b;

    sput-object v1, Ll5/d0;->b:Ll5/d0;
    ...
    :cond_0
    :goto_0
    sget-object p0, Ll5/d0;->b:Ll5/d0;
    :try_end_0
...
.method public final declared-synchronized b()V
    ...
    :try_start_0
    iget-object v0, p0, Ll5/d0;->a:Ll5/b;
    ...
    :cond_0
    :try_start_1
    const-string v2, "preferred_contacts"
    ...
    const-string v0, "successfully deleted the preferred contacts by call list"
...
.method public final declared-synchronized d(Ljava/util/List;)V
    ...
    iget-object v5, v2, LZ5/P;->n:LZ5/O;

    iget v5, v5, LZ5/O;->a:I
    ...
    iget-object v5, v5, LZ5/O;->b:Ljava/lang/String;
    ...
    const-string v4, "preferred_call_type"

    iget-object v5, v2, LZ5/P;->o:LZ5/N;
    ...
    const-string v4, "main_phone_number"

    iget-object v5, v2, LZ5/P;->p:Ljava/lang/String;
    ...
    :cond_5
    iget-object v1, p0, Ll5/d0;->a:Ll5/b;
    ...
    const-string v4, "preferred_contacts"
    ...
    const-string v1, "successfully inserted the preferred contacts by call list, size="
    ...
    const-string v3, "successfully inserted the preferred contacts by call list, size="
