...
# instance fields
.field public m:LE5/e;

.field public n:Lc7/c;
...
.method static constructor <clinit>()V
    ...
    sput-wide v3, LI5/i;->q:J

    invoke-virtual {v0, v1, v2}, Ljava/util/concurrent/TimeUnit;->toMillis(J)J

    move-result-wide v0

    sput-wide v0, LI5/i;->r:J
...
.method public final a(LD5/a;)V
    ...
    iput-wide v4, p0, LI5/i;->p:J

    iput-boolean v3, p0, LI5/c;->f:Z

    invoke-virtual {p0, v0}, LI5/c;->f(LD5/a;)V

    invoke-virtual {p0}, LI5/i;->j()V

    new-instance v0, Ljava/lang/StringBuilder;

    const-string v1, "resetAlarm - PRESENCE_6H_SCHEDULE_TIME("

    invoke-direct {v0, v1}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    sget-wide v4, LI5/i;->r:J
    ...
    const-string v6, "Presence6HTriggerModel"

    invoke-static {v6, v0}, LA8/b;->l(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Ljava/lang/StringBuilder;

    const-string v7, "resetAlarm - PRESENCE_SCHEDULE_TIME("
    ...
    iget-object v0, p0, LI5/i;->m:LE5/e;
    ...
    invoke-direct {v7, p0, p1, v8}, LI5/g;-><init>(LI5/c;LD5/a;I)V

    iput-object v7, v0, LE5/e;->e:LI5/g;

    const-string p1, "Presence6HTriggerModelAlarm"

    const-string v7, "schedule"

    invoke-static {p1, v7}, LA8/b;->l(Ljava/lang/String;Ljava/lang/String;)V

    new-array v8, v2, [Ljava/lang/Object;

    invoke-static {v7, v8}, Lz8/e;->i(Ljava/lang/String;[Ljava/lang/Object;)V

    const-string v7, "setPresence6HAlarm"
    ...
    iput-object v7, v0, LE5/e;->b:Landroid/content/Intent;

    sget-object v8, LE5/e;->f:Ljava/lang/String;

    invoke-virtual {v7, v8}, Landroid/content/Intent;->addCategory(Ljava/lang/String;)Landroid/content/Intent;

    iget-object v7, v0, LE5/e;->b:Landroid/content/Intent;
    ...
    iget-object v9, v0, LE5/e;->a:Landroid/content/Context;
    ...
    invoke-static {v9, v11, v7, v10}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v7

    iput-object v7, v0, LE5/e;->c:Landroid/app/PendingIntent;

    new-instance v7, Landroid/content/IntentFilter;

    invoke-direct {v7, v8}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    iget-object v10, v0, LE5/e;->d:LB5/c;

    const/4 v11, 0x2

    invoke-virtual {v9, v10, v7, v11}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;I)Landroid/content/Intent;
    ...
    iget-object v0, v0, LE5/e;->c:Landroid/app/PendingIntent;

    invoke-virtual {v7, v3, v11, v12, v0}, Landroid/app/AlarmManager;->setExact(IJLandroid/app/PendingIntent;)V

    new-instance v0, Ljava/lang/StringBuilder;

    const-string v3, "setPresence6HAlarm done - interval "
    ...
    const-string v3, "Presence6HTriggerModelAlarmsetPresence6HAlarm done - interval "
    ...
    invoke-virtual {v3, v10, v0}, LY/b;->b(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V

    const-string v0, "registerCheckForPresence6HAlarmReceiver"
    ...
    invoke-static {v6, p1}, LA8/b;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_a
    iget-object p1, p0, LI5/i;->o:LH5/b;

    if-eqz p1, :cond_b

    const-string v0, "presence_6h_trm_last_event_time"

    iget-wide v1, p0, LI5/i;->p:J
...
.method public final h()V
    ...
    iget-object v1, p0, LI5/i;->o:LH5/b;

    if-eqz v1, :cond_1

    const-string v2, "presence_6h_trm_last_event_time"
    ...
    iget-object p0, p0, LI5/i;->o:LH5/b;
...
.method public final j()V
    ...
    iget-object p0, p0, LI5/i;->m:LE5/e;

    const-string v0, "Presence6HTriggerModel"
    ...
    const-string v2, "Presence6HTriggerModelAlarm"
    ...
    iget-object v3, p0, LE5/e;->a:Landroid/content/Context;
    ...
    iget-object v5, p0, LE5/e;->c:Landroid/app/PendingIntent;

    if-eqz v5, :cond_2

    invoke-virtual {v4, v5}, Landroid/app/AlarmManager;->cancel(Landroid/app/PendingIntent;)V

    const-string v4, "cancel CheckForPresence6HAlarm"
    ...
    iget-object v4, p0, LE5/e;->b:Landroid/content/Intent;
    ...
    iput-object v4, p0, LE5/e;->b:Landroid/content/Intent;

    iput-object v4, p0, LE5/e;->c:Landroid/app/PendingIntent;
    ...
    :goto_0
    const-string v4, "unregisterCheckForPresence6HAlarmReceiver"
    ...
    iget-object p0, p0, LE5/e;->d:LB5/c;
    ...
    :goto_1
    const-string p0, "mPresence6HTriggerModelAlarm - dismissed"
    ...
    :cond_5
    const-string p0, "mPresence6HTriggerModelAlarm is null"
