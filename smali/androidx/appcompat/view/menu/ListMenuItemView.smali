...
.field public final a0:Ljava/text/NumberFormat;
...
.field public d0:Landroidx/appcompat/widget/SeslDropDownItemTextView;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {v1, p2, v2, v3}, LH6/f;->j(Landroid/content/Context;Landroid/util/AttributeSet;[II)LH6/f;

    move-result-object p2

    const/4 v1, 0x5

    invoke-virtual {p2, v1}, LH6/f;->f(I)Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a0:Ljava/text/NumberFormat;
...
.method private setBadgeText(Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->e0:Landroid/widget/LinearLayout;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b0:Landroid/widget/TextView;
    ...
    iget-object v5, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a0:Ljava/text/NumberFormat;
    ...
    iget-object v6, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b0:Landroid/widget/TextView;
    ...
    :cond_4
    iget-object v5, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b0:Landroid/widget/TextView;
    ...
    :cond_5
    iget-object p0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b0:Landroid/widget/TextView;
...
.method public final a(Lm/k;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lm/k;
    ...
    iget-object v0, p1, Lm/k;->e:Ljava/lang/CharSequence;

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ListMenuItemView;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {p1}, Lm/k;->isCheckable()Z

    move-result v0

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ListMenuItemView;->setCheckable(Z)V

    iget-object v0, p1, Lm/k;->n:Lm/i;

    invoke-virtual {v0}, Lm/i;->o()Z
    ...
    invoke-virtual {v0}, Lm/i;->n()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-char v0, p1, Lm/k;->j:C

    goto :goto_1

    :cond_1
    iget-char v0, p1, Lm/k;->h:C
    ...
    :goto_2
    iget-object v4, p1, Lm/k;->n:Lm/i;

    invoke-virtual {v4}, Lm/i;->n()Z

    iget-boolean v4, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->c0:Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lm/k;

    iget-object v4, v0, Lm/k;->n:Lm/i;

    invoke-virtual {v4}, Lm/i;->o()Z
    ...
    iget-char v0, v0, Lm/k;->j:C

    goto :goto_3

    :cond_4
    iget-char v0, v0, Lm/k;->h:C
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lm/k;

    iget-object v5, v4, Lm/k;->n:Lm/i;

    invoke-virtual {v5}, Lm/i;->n()Z

    move-result v5

    if-eqz v5, :cond_7

    iget-char v5, v4, Lm/k;->j:C

    goto :goto_6

    :cond_7
    iget-char v5, v4, Lm/k;->h:C
    ...
    :cond_8
    iget-object v6, v4, Lm/k;->n:Lm/i;

    iget-object v7, v6, Lm/i;->a:Landroid/content/Context;
    ...
    iget-object v9, v6, Lm/i;->a:Landroid/content/Context;
    ...
    invoke-static {v8, v4, v9, v6}, Lm/k;->b(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v4, v3, v6}, Lm/k;->b(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v4, v6, v3}, Lm/k;->b(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v4, v1, v3}, Lm/k;->b(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    iget-object p1, p1, Lm/k;->W:Ljava/lang/CharSequence;
...
.method public getItemData()Lm/k;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lm/k;
...
.method public final onFinishInflate()V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->d0:Landroidx/appcompat/widget/SeslDropDownItemTextView;
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iget-object v0, v0, Lm/k;->e:Ljava/lang/CharSequence;
...
.method public setCheckable(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->d0:Landroidx/appcompat/widget/SeslDropDownItemTextView;

    iget-object p0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lm/k;

    invoke-virtual {p0}, Lm/k;->isChecked()Z
...
.method public setChecked(Z)V
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->d0:Landroidx/appcompat/widget/SeslDropDownItemTextView;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->d0:Landroidx/appcompat/widget/SeslDropDownItemTextView;
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/L0;->setVisibility(I)V
    ...
    invoke-virtual {p0, v2}, Landroidx/appcompat/widget/L0;->setVisibility(I)V
