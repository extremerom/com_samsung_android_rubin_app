...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v1, v0, LTa/d;->a:Z

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->a:LTa/d;
    ...
    invoke-static {p1, v0}, LJ6/f;->m(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
# virtual methods
.method public final c(LDa/j0;)V
    .locals 5

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->e0:Z
    ...
    invoke-virtual {p1}, LDa/j0;->g()Lm/i;

    move-result-object p1

    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->d:Landroidx/appcompat/widget/m;

    if-eqz v1, :cond_2

    invoke-virtual {v1}, Landroidx/appcompat/widget/m;->e()Z

    iget-object v1, v1, Landroidx/appcompat/widget/m;->Z:Landroidx/appcompat/widget/g;

    if-eqz v1, :cond_2

    invoke-virtual {v1}, Lm/r;->b()Z

    move-result v3

    if-eqz v3, :cond_2

    iget-object v1, v1, Lm/r;->i:Lm/y;

    invoke-virtual {v1}, Lm/y;->dismiss()V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->d:Landroidx/appcompat/widget/m;
    ...
    invoke-virtual {p1, v1, v3}, Lm/i;->b(Lm/t;Landroid/content/Context;)V

    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarContextView;->d:Landroidx/appcompat/widget/m;

    iget-object v1, p1, Landroidx/appcompat/widget/m;->h:Lm/v;
    ...
    iput-object v2, p1, Landroidx/appcompat/widget/m;->h:Lm/v;

    iget-object v3, p1, Landroidx/appcompat/widget/m;->c:Lm/i;

    invoke-interface {v2, v3}, Lm/v;->b(Lm/i;)V

    invoke-virtual {p1}, Landroidx/appcompat/widget/m;->c()V

    :cond_3
    iget-object v2, p1, Landroidx/appcompat/widget/m;->h:Lm/v;
...
.method public getAnimatedVisibility()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->f:LM/L;

    if-eqz v0, :cond_0

    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarContextView;->a:LTa/d;
...
.method public final j(IJ)LM/L;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->a:LTa/d;
    ...
    :cond_1
    invoke-static {p0}, LM/G;->a(Landroid/view/View;)LM/L;

    move-result-object p0

    const/high16 v1, 0x3f800000    # 1.0f

    invoke-virtual {p0, v1}, LM/L;->a(F)V

    invoke-virtual {p0, p2, p3}, LM/L;->c(J)V

    iget-object p2, v0, LTa/d;->c:Ljava/lang/Object;

    check-cast p2, Landroidx/appcompat/widget/ActionBarContextView;

    iput-object p0, p2, Landroidx/appcompat/widget/ActionBarContextView;->f:LM/L;

    iput p1, v0, LTa/d;->b:I

    invoke-virtual {p0, v0}, LM/L;->d(LM/M;)V
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    iget-boolean v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->e0:Z
    ...
    iput-boolean v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->d0:Z

    iput-boolean v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->e0:Z

    goto :goto_0

    :cond_0
    iput-boolean v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->d0:Z
    ...
    iget-boolean v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->d0:Z
...
.method public final onMeasure(II)V
    ...
    :cond_a
    iget-boolean v7, p0, Landroidx/appcompat/widget/ActionBarContextView;->b0:Z
