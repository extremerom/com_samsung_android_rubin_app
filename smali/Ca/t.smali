...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v0}, LUa/f;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    const-string v2, "java/lang/annotation/Annotation.annotationType()Ljava/lang/Class;"

    invoke-static {v2, v0}, Lca/A;->u(Ljava/lang/Object;Ljava/util/Set;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, LCa/t;->a:Ljava/util/LinkedHashSet;

    sget-object v0, Ljb/c;->e:Ljb/c;

    sget-object v2, Ljb/c;->f:Ljb/c;

    filled-new-array {v0, v2}, [Ljb/c;
    ...
    invoke-virtual {v5}, Lbb/f;->b()Ljava/lang/String;
    ...
    iget-object v6, v3, Ljb/c;->b:Ljava/lang/String;
    ...
    invoke-static {v5, v3}, LUa/f;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v3, v0}, LUa/f;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    invoke-static {v2, v0}, Lca/A;->v(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v2}, LUa/f;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v7}, LUa/f;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v7

    invoke-static {v0, v7}, Lca/A;->v(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v6, v2}, LUa/f;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v7, v2}, LUa/f;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, LCa/t;->b:Ljava/util/LinkedHashSet;
    ...
    sput-object v0, LCa/t;->c:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v7, v0}, LUa/f;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v7, v2}, LUa/f;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v2}, LUa/f;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1, v2}, LUa/f;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v3, v2}, LUa/f;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, LCa/t;->d:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v3, v1}, LUa/f;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v7, v1}, LUa/f;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, LCa/t;->e:Ljava/util/LinkedHashSet;

    sget-object v9, Ljb/c;->e:Ljb/c;

    sget-object v13, Ljb/c;->g:Ljb/c;

    sget-object v11, Ljb/c;->l:Ljb/c;

    sget-object v12, Ljb/c;->j:Ljb/c;

    sget-object v14, Ljb/c;->i:Ljb/c;

    sget-object v15, Ljb/c;->k:Ljb/c;

    sget-object v16, Ljb/c;->h:Ljb/c;

    move-object v10, v13

    filled-new-array/range {v9 .. v16}, [Ljb/c;
    ...
    invoke-virtual {v2}, Ljb/c;->h()Lbb/c;
    ...
    invoke-static {v2, v3}, LUa/f;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v0}, LUa/f;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v6, v0}, LUa/f;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    invoke-static {v1, v0}, Lca/A;->v(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1}, LUa/f;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v5, v1}, LUa/f;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, LCa/t;->f:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v0}, LUa/f;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, LCa/t;->g:Ljava/util/LinkedHashSet;
