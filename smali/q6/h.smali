...
.method public static a(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;)Landroid/graphics/RectF;
    ...
    instance-of p0, p1, LV2/i;

    if-eqz p0, :cond_2

    check-cast p1, LV2/i;

    invoke-virtual {p1}, LV2/i;->getContentWidth()I

    move-result p0

    invoke-virtual {p1}, LV2/i;->getContentHeight()I
...
# virtual methods
.method public b(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    .locals 1
    ...
    invoke-static {p2, v0, p3}, LA2/a;->c(IFI)I
    ...
    invoke-static {p0, v0, p1}, LA2/a;->c(IFI)I
